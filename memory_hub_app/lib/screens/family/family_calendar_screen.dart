            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (event.genealogyPersonName != null || event.autoGenerated) ...[
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        if (event.autoGenerated) ...[
                          ...
                          if (event.genealogyPersonName != null) const SizedBox(width: 8),
                        ],
                        if (event.genealogyPersonName != null) ...[
                          Icon(Icons.family_restroom, size: 14, color: Colors.grey.shade600),
                          const SizedBox(width: 4),
                          Expanded(
                            child: Text(
